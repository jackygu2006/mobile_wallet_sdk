...
import type { ValidatorPrefs, ValidatorPrefsWithBlocked } from '@polkadot/custom-interfaces/interfaces/staking';
import type { CountryCode, CustodyInfo, DepositNonce, GeoBin, IdealInterestPoint, InflationFixedParams, Performance, PointsMultiplier, ProposalVotes, ResourceId, RewardPoints, SoftwareHashes, Timeouts, UserRegistration, Variables } from '@polkadot/custom-interfaces/interfaces/xxnetwork';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    i8: i8;
    I8: I8;
    IdealInterestPoint: IdealInterestPoint;
    ...
    InflationFixedParams: InflationFixedParams;
