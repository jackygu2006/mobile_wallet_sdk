...
import type { Bytes, Compact, Data, Option, Vec, bool, u16, u32, u64, u8 } from '@polkadot/types';
import type { AnyNumber, ITuple } from '@polkadot/types/types';
import type { DepositNonce, IdealInterestPoint, InflationFixedParams, ResourceId, SoftwareHashes, Variables } from '@polkadot/custom-interfaces/interfaces/xxnetwork';
...
import type { AccountId, Balance, BalanceOf, BlockNumber, Call, CallHashOf, ChangesTrieConfiguration, Hash, Header, KeyValue, LookupSource, Moment, Perbill, Percent, Weight } from '@polkadot/types/interfaces/runtime';
import type { Period, Priority } from '@polkadot/types/interfaces/scheduler';
import type { Keys } from '@polkadot/types/interfaces/session';
import type { ElectionScore, EraIndex, RawSolution, SolutionOrSnapshotSize, Supports, ValidatorPrefs } from '@polkadot/types/interfaces/staking';
...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    ...
    staking: {
       ...
       * 
       * NOTE: One of the storage writes (`Self::bonded`) are _never_ cleaned
       ...
       * # </weight>
       **/
      bond: AugmentedSubmittable<(controller: LookupSource | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, value: Compact<BalanceOf> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [LookupSource, Compact<BalanceOf>]>;
      /**
       ...
       * Writes: Bonded, Slashing Spans (if S > 0), Ledger, Validators, Nominators, Account, Locks
       ...
       * - Read Each: Bonded, Ledger, Locks, System Account (5 items)
       ...
       * - Writes: Bonded, Slashing Spans (if S > 0), Ledger, Validators, Nominators, Stash Account, Locks
       * - Writes Each: SpanSlash * S
       * # </weight>
       **/
      ...
      /**
       * Sets the minimum bond required to be a validator.
       * 
       * The dispatch origin must be AdminOrigin.
       * 
       * # <weight>
       * Weight: O(1)
       * Write: Validator Min Bond
       * # </weight>
       **/
      setValidatorMinBond: AugmentedSubmittable<(updated: Compact<BalanceOf> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<BalanceOf>]>;
      /**
       ...
       * # </weight>
       **/
      validate: AugmentedSubmittable<(prefs: ValidatorPrefs | { commission?: any; blocked?: any; cmix_root?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [ValidatorPrefs]>;
      /**
    ...
    swap: {
       ...
       * Set fee destination
       **/
      setFeeDestination: AugmentedSubmittable<(dest: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId]>;
      /**
       * Set swap fee
       **/
      setSwapFee: AugmentedSubmittable<(fee: Compact<BalanceOf> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<BalanceOf>]>;
      /**
    ...
    xxNetwork: {
       ...
       * # </weight>
       **/
      addCustodian: AugmentedSubmittable<(custodian: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId]>;
      /**
       ...
       * # </weight>
       **/
      custodyBond: AugmentedSubmittable<(custody: AccountId | string | Uint8Array, controller: AccountId | string | Uint8Array, value: Compact<BalanceOf> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId, AccountId, Compact<BalanceOf>]>;
      /**
       ...
       * # </weight>
       **/
      custodyBondExtra: AugmentedSubmittable<(custody: AccountId | string | Uint8Array, value: Compact<BalanceOf> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId, Compact<BalanceOf>]>;
      /**
       ...
       * # </weight>
       **/
      custodySetController: AugmentedSubmittable<(custody: AccountId | string | Uint8Array, controller: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId, AccountId]>;
      /**
       ...
       * # </weight>
       **/
      custodySetProxy: AugmentedSubmittable<(custody: AccountId | string | Uint8Array, proxy: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId, AccountId]>;
      /**
       ...
       * # </weight>
       **/
      payout: AugmentedSubmittable<(who: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId]>;
      /**
       ...
       * # </weight>
       **/
      removeCustodian: AugmentedSubmittable<(custodian: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId]>;
      /**
       ...
       * # </weight>
       **/
      replaceTeamMember: AugmentedSubmittable<(who: AccountId | string | Uint8Array, updated: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId, AccountId]>;
      /**
       ...
       * # </weight>
       **/
      setAdminPermission: AugmentedSubmittable<(permission: BlockNumber | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [BlockNumber]>;
      /**
       ...
       * # </weight>
       **/
      setCmixHashes: AugmentedSubmittable<(hashes: SoftwareHashes | { server?: any; fatbin?: any; libpow?: any; gateway?: any; scheduling?: any; wrapper?: any; udb?: any; notifications?: any; extra?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [SoftwareHashes]>;
      /**
       ...
       * # </weight>
       **/
      setInflationParams: AugmentedSubmittable<(params: InflationFixedParams | { min_inflation?: any; ideal_stake?: any; falloff?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [InflationFixedParams]>;
      /**
       ...
       * # </weight>
       **/
      setInterestPoints: AugmentedSubmittable<(points: Vec<IdealInterestPoint> | (IdealInterestPoint | { block?: any; interest?: any } | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [Vec<IdealInterestPoint>]>;
      /**
       ...
       * # </weight>
       **/
      setLiquidityRewardsBalance: AugmentedSubmittable<(amount: Compact<BalanceOf> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<BalanceOf>]>;
      /**
       ...
       * # </weight>
       **/
      setLiquidityRewardsStake: AugmentedSubmittable<(amount: Compact<BalanceOf> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<BalanceOf>]>;
      /**
       ...
       * # </weight>
       **/
      setNextCmixVariables: AugmentedSubmittable<(variables: Variables | { performance?: any; timeouts?: any; scheduling?: any; registration?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Variables]>;
      /**
       ...
       * # </weight>
       **/
      setSchedulingAccount: AugmentedSubmittable<(who: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId]>;
      /**
       ...
       * # </weight>
       **/
      submitCmixDeductions: AugmentedSubmittable<(data: Vec<ITuple<[AccountId, u32]>> | ([AccountId | string | Uint8Array, u32 | AnyNumber | Uint8Array])[]) => SubmittableExtrinsic<ApiType>, [Vec<ITuple<[AccountId, u32]>>]>;
      /**
       ...
       * # </weight>
       **/
      submitCmixPoints: AugmentedSubmittable<(data: Vec<ITuple<[AccountId, u32]>> | ([AccountId | string | Uint8Array, u32 | AnyNumber | Uint8Array])[]) => SubmittableExtrinsic<ApiType>, [Vec<ITuple<[AccountId, u32]>>]>;
      /**
       ...
       * # </weight>
       **/
      teamCustodySetProxy: AugmentedSubmittable<(proxy: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId]>;
    };
  }
